...
def test_extract_repository_from_ecr_url_with_namespace():
    registry_info = extract_repository_from_ecr_url(
        '5555555555.dkr.ecr.eu-central-1.amazonaws.com/eks-odahuflow-test/counter-3.3:460c-8f3c-eb3b3d2e1d98'
    )

    assert registry_info == ECRRegistry(id='5555555555', repository_name='eks-odahuflow-test/counter-3.3')
